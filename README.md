...
Sanitized documentation from a real PCI-DSS compliance engagement.

i'm not a security professional — i was brought in as an operational coordinator
to help a small business navigate their first PCI-DSS remediation. this repo
documents what i learned and what the process looked like from the inside.

## context
- **environment**: small dental practice processing credit card payments
- **standard**: PCI-DSS (Payment Card Industry Data Security Standard)
- **role**: compliance coordination, documentation, vendor communication
- **outcome**: remediation plan completed and submitted
